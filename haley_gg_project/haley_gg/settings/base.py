"""
Django settings for haley_gg project.
...
with open('haley_gg/settings/secrets.json') as f:
...
WSGI_APPLICATION = 'haley_gg.wsgi.application'


# Database
# https://docs.djangoproject.com/en/3.1/ref/settings/#databases
DB_KEY = get_secret("POSTGRES")
